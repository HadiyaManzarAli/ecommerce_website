...
<html>
    <head>
        <title>Contact Us | Paw Planet</title>
        ...
        <div class="col-sm-3">
	       <div class="contact-info">
	           <h2 class="title">Contact Info</h2>
	               <address>
				    <p>Paw<i class="fas fa-paw"></i> Planet </p>
				    <p>Jinnah University For Women,North Nazimabad</p>
				    <p>Karachi,Pakistan</p>
				    <p>Phone:(+92) 9447511526</p>
				    <p>Email:pawplanet@gmail.com</p>
	               </address>
	               
	            <div><h2 class="title">Follow Us On&#58;</h2>
                   <a href="http://www.facebook.com/login" target="_blank"><img src="./img/logofb.png" alt="fb logo" style="width:30px; height:30px; border:0"></a>
                   <a href="http://www.twitter.com/login" target="_blank"><img src="./img/logotwitter.png" alt="twitter logo" style="width:30px; height:30px; border:0;"></a>
                   <a href="http://www.instagram.com/login" target="_blank"><img src="./img/insta.png" alt="twitter logo" style="width:30px; height:30px; border:0; "></a>
               </div>
            </div>
        </div>
    </div>
